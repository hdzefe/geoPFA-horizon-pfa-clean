    def save_debug_borehole_csv(self, horizon_name, merged_valid, geotis_available, temperature_at_boreholes, gradient_temps, temp_blended, depth_col):
        """
        ...
        Args:
            ...
            depth_col: Name of depth column (het1_mean_depth, etc.)
        """
        debug_df = pd.DataFrame({
            ...
            'mean_depth_m': merged_valid[depth_col].values,
